...
INSERT INTO MPA_RATINGS (RATING_NAME) SELECT 'G'     WHERE NOT EXISTS (SELECT * FROM MPA_RATINGS WHERE RATING_NAME='G');
INSERT INTO MPA_RATINGS (RATING_NAME) SELECT 'PG'    WHERE NOT EXISTS (SELECT * FROM MPA_RATINGS WHERE RATING_NAME='PG');
INSERT INTO MPA_RATINGS (RATING_NAME) SELECT 'PG-13' WHERE NOT EXISTS (SELECT * FROM MPA_RATINGS WHERE RATING_NAME='PG-13');
INSERT INTO MPA_RATINGS (RATING_NAME) SELECT 'R'     WHERE NOT EXISTS (SELECT * FROM MPA_RATINGS WHERE RATING_NAME='R');
INSERT INTO MPA_RATINGS (RATING_NAME) SELECT 'NC-17' WHERE NOT EXISTS (SELECT * FROM MPA_RATINGS WHERE RATING_NAME='NC-17');
